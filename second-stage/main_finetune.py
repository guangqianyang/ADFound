...
def main():
    ...
    train_loader, val_loader = build_data_adni2_paired_data(args.batch_size, args.input_D, args.input_H, args.input_W, workers=16)
    ...
    train(net, criterion, optimizer, train_loader, val_loader, device, max_epoch, scheduler, writer)
            
def train(net, criterion, optimizer, train_loader, val_loader, device, max_epoch, scheduler, writer):
    best_acc = 0
    best_f1_score = 0
    best_train_acc = 0
    ...
    for epoch in range(max_epoch):
        ...
        writer.add_scalar('F1 socre/val', val_f1_score, epoch)
